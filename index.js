...
if (version < 16) {
  console.log(`${color.red(`[ERROR] XenixNitro Tickets requires a NodeJS version of 16.9 or higher!`)}`)

  let logMsg = `\n\n[${new Date().toLocaleString()}] [ERROR] XenixNitro Tickets requires a NodeJS version of 16.9 or higher!`;
